...
FC_TRAIN = Setting()
FC_TRAIN.TRAIN_FILE = "kaggle/CauseEffectPairsChallenge-master/data/combination/pairs.csv"
FC_TRAIN.VALID_FILE = "kaggle/CauseEffectPairsChallenge-master/data/CEfinal/CEfinal_valid_pairs.csv"
...
FC_TRAIN.CLF = GradientBoostingRegressor(loss='huber', n_estimators=5000, random_state=1, min_samples_split=2,
                                         min_samples_leaf=1, subsample=1.0, max_features=686, alpha=0.995355212043,
                                         max_depth=10, learning_rate=np.exp(-4.09679792914))
...
TEST_ONLY = Setting()
TEST_ONLY.CLF_DIR = "kaggle/CauseEffectPairsChallenge-master/clf"
